 ...
 * Mid-tier SMP scale — between tiny starter prices and DonutSMP millions.
 */
public final class SellService {
	/** Bump when default price table changes — auto-regenerates sell-prices.yml. */
	private static final int PRICE_TABLE_VERSION = 4;
	...
	public void load() {
		...
		if (!file.exists()) {
			...
			save();
			plugin.getLogger().info("Created sell-prices.yml with " + prices.size() + " mid-tier sell prices.");
			return;
		}
		...
		if (fileVersion < PRICE_TABLE_VERSION) {
			prices.putAll(defaults);
			save();
			plugin.getLogger().info("Upgraded sell-prices.yml to mid-tier v" + PRICE_TABLE_VERSION
					+ " (" + prices.size() + " prices).");
			return;
		}
	...
	public void save() {
		...
		data.options().header(String.join("\n",
				"Mid-tier SMP sell prices for every item/block (between cheap starter & Donut millions).",
				"Examples: cobble $1, oak log $5, sand $2, iron $8, diamond $100, debris $5,000.",
	...
	/**
	 * Mid-tier SMP prices — useful but not Donut-inflated.
	 * Rough anchors: cobble $1, log $5, sand $2, iron $8, diamond $100, debris $5k.
	 */
	static double computePrice(Material mat) {
		String n = mat.name();

		// === Ultra rares ===
		if (n.equals("DRAGON_EGG")) return 100_000.00;
		if (n.equals("NETHER_STAR")) return 40_000.00;
		if (n.equals("BEACON")) return 45_000.00;
		if (n.equals("ELYTRA")) return 25_000.00;
		if (n.equals("ENCHANTED_GOLDEN_APPLE")) return 12_000.00;
		if (n.equals("HEAVY_CORE") || n.equals("MACE")) return 20_000.00;
		if (n.equals("TOTEM_OF_UNDYING")) return 5_000.00;
		if (n.equals("HEART_OF_THE_SEA")) return 3_000.00;
		if (n.equals("CONDUIT")) return 6_000.00;
		if (n.equals("SHULKER_SHELL")) return 1_500.00;
		if (n.contains("SHULKER_BOX")) return 6_000.00;
		if (n.equals("DRAGON_HEAD")) return 8_000.00;
		if (n.equals("DRAGON_BREATH")) return 400.00;
		if (n.equals("WITHER_SKELETON_SKULL")) return 4_000.00;
		if (n.endsWith("_HEAD") || n.endsWith("_SKULL")) return 250.00;
		if (n.equals("SPAWNER") || n.equals("TRIAL_SPAWNER") || n.equals("VAULT")) return 50_000.00;
		if (n.equals("ECHO_SHARD")) return 800.00;
		if (n.equals("RECOVERY_COMPASS")) return 3_500.00;
		if (n.equals("TRIDENT")) return 2_500.00;
		if (n.equals("NAUTILUS_SHELL")) return 600.00;
		if (n.equals("SPONGE") || n.equals("WET_SPONGE")) return 500.00;
		if (n.equals("NAME_TAG")) return 350.00;
		if (n.equals("SADDLE")) return 400.00;
		if (n.equals("END_CRYSTAL")) return 600.00;
		if (n.equals("GHAST_TEAR")) return 300.00;
		if (n.equals("PHANTOM_MEMBRANE")) return 120.00;
		if (n.equals("BREEZE_ROD")) return 250.00;
		if (n.equals("WIND_CHARGE")) return 40.00;

		// === Netherite ===
		if (n.equals("ANCIENT_DEBRIS")) return 5_000.00;
		if (n.equals("NETHERITE_SCRAP")) return 5_500.00;
		if (n.equals("NETHERITE_INGOT")) return 25_000.00;
		if (n.equals("NETHERITE_BLOCK")) return 225_000.00;
		if (n.contains("NETHERITE")) {
			...
			if (n.contains("UPGRADE")) return 15_000.00;
			return 8_000.00;
		}

		// === Diamond ===
		if (n.contains("DIAMOND")) {
			if (n.contains("BLOCK")) return 900.00;
			if (n.equals("DIAMOND")) return 100.00;
			if (n.contains("ORE")) return 80.00;
			if (n.contains("SWORD") || n.contains("AXE") || n.contains("PICKAXE") || n.contains("HOE")
					|| n.contains("SHOVEL") || n.contains("HELMET") || n.contains("CHESTPLATE")
		...
		if (n.contains("EMERALD")) {
			if (n.contains("BLOCK")) return 720.00;
			if (n.equals("EMERALD")) return 80.00;
			if (n.contains("ORE")) return 65.00;
			return 50.00;
		}

		// === Gold ===
		if (n.equals("GOLDEN_APPLE")) return 200.00;
		if (n.equals("GOLDEN_CARROT")) return 25.00;
		if (n.equals("NETHER_GOLD_ORE")) return 20.00;
		if (n.contains("GOLD") || n.startsWith("GOLDEN_")) {
			if (n.contains("BLOCK")) return 135.00;
			if (n.contains("INGOT")) return 15.00;
			if (n.contains("NUGGET")) return 1.70;
			if (n.contains("ORE") || n.contains("RAW_GOLD")) return 12.00;
			if (n.contains("SWORD") || n.contains("AXE") || n.contains("PICKAXE") || n.contains("HOE")
					|| n.contains("SHOVEL") || n.contains("HELMET") || n.contains("CHESTPLATE")
					|| n.contains("LEGGINGS") || n.contains("BOOTS") || n.contains("HORSE_ARMOR")
					|| n.endsWith("_SPEAR")) {
		...
		if (n.contains("IRON")) {
			if (n.contains("BLOCK")) return 72.00;
			if (n.contains("INGOT")) return 8.00;
			if (n.contains("NUGGET")) return 0.90;
			if (n.contains("ORE") || n.contains("RAW_IRON")) return 6.00;
			if (n.contains("SWORD") || n.contains("AXE") || n.contains("PICKAXE") || n.contains("HOE")
					|| n.contains("SHOVEL") || n.contains("HELMET") || n.contains("CHESTPLATE")
					|| n.contains("LEGGINGS") || n.contains("BOOTS") || n.contains("HORSE_ARMOR")
					|| n.endsWith("_SPEAR")) {
		...
		if (n.contains("COPPER") || n.contains("EXPOSED_") || n.contains("WEATHERED_") || n.contains("OXIDIZED_")) {
			...
			if (n.contains("INGOT")) return 4.00;
			if (n.contains("ORE") || n.contains("RAW_COPPER")) return 3.00;
			if (n.contains("NUGGET")) return 0.45;
			if (n.contains("SWORD") || n.contains("AXE") || n.contains("PICKAXE") || n.contains("HOE")
					|| n.contains("SHOVEL") || n.contains("HELMET") || n.contains("CHESTPLATE")
					|| n.contains("LEGGINGS") || n.contains("BOOTS") || n.endsWith("_SPEAR")) {
				return 18.00;
		...
		if (n.equals("COAL") || n.equals("CHARCOAL")) return 3.00;
		if (n.equals("COAL_BLOCK")) return 27.00;
		if (n.contains("COAL_ORE")) return 4.00;
		if (n.equals("REDSTONE")) return 4.00;
		if (n.equals("REDSTONE_BLOCK")) return 36.00;
		if (n.contains("REDSTONE_ORE")) return 5.00;
		if (n.equals("LAPIS_LAZULI")) return 5.00;
		if (n.equals("LAPIS_BLOCK")) return 45.00;
		if (n.contains("LAPIS_ORE")) return 6.00;
		if (n.equals("QUARTZ")) return 6.00;
		if (n.contains("QUARTZ") && n.contains("BLOCK")) return 24.00;
		if (n.contains("NETHER_QUARTZ_ORE")) return 7.00;
		if (n.equals("AMETHYST_SHARD")) return 8.00;
		if (n.contains("AMETHYST")) return 20.00;
		if (n.equals("GILDED_BLACKSTONE")) return 80.00;

		// === Spawn eggs / buckets ===
		if (n.endsWith("_SPAWN_EGG")) return 1_000.00;
		if (n.equals("BUCKET")) return 6.00;
		if (n.equals("WATER_BUCKET") || n.equals("LAVA_BUCKET") || n.equals("POWDER_SNOW_BUCKET")
				|| n.equals("MILK_BUCKET")) {
			return 10.00;
		}
		if (n.contains("BUCKET")) return 80.00;

		// === Discs / pottery / templates ===
		if (n.startsWith("MUSIC_DISC_")) return 400.00;
		if (n.endsWith("_POTTERY_SHERD")) return 120.00;
		if (n.endsWith("_SMITHING_TEMPLATE") || n.contains("ARMOR_TRIM") || n.endsWith("_TRIM")) return 600.00;
		if (n.equals("ENCHANTED_BOOK")) return 150.00;
		if (n.equals("EXPERIENCE_BOTTLE")) return 25.00;

		// === Mob drops ===
		if (n.equals("LEATHER")) return 12.00;
		if (n.equals("ENDER_PEARL")) return 40.00;
		if (n.equals("ENDER_EYE")) return 65.00;
		if (n.equals("BLAZE_ROD")) return 50.00;
		if (n.equals("BLAZE_POWDER")) return 25.00;
		if (n.equals("MAGMA_CREAM")) return 20.00;
		if (n.equals("SLIME_BALL")) return 12.00;
		if (n.equals("SLIME_BLOCK")) return 108.00;
		if (n.equals("GUNPOWDER")) return 8.00;
		if (n.equals("BONE")) return 3.00;
		if (n.equals("BONE_BLOCK")) return 27.00;
		if (n.equals("BONE_MEAL")) return 0.40;
		if (n.equals("STRING")) return 2.50;
		if (n.equals("ROTTEN_FLESH")) return 0.50;
		if (n.equals("SPIDER_EYE") || n.equals("FERMENTED_SPIDER_EYE")) return 4.00;
		if (n.equals("FEATHER")) return 2.00;
		if (n.equals("ARROW") || n.contains("_ARROW")) return 1.25;
		if (n.equals("PRISMARINE_SHARD")) return 3.00;
		if (n.equals("PRISMARINE_CRYSTALS")) return 6.00;
		if (n.equals("INK_SAC") || n.equals("GLOW_INK_SAC")) return 2.50;
		if (n.equals("RABBIT_HIDE") || n.equals("RABBIT_FOOT")) return 10.00;
		if (n.equals("SCUTE") || n.equals("TURTLE_SCUTE") || n.equals("ARMADILLO_SCUTE")) return 80.00;

		// === Farm / crop ===
		if (n.equals("BAMBOO_BLOCK") || n.equals("STRIPPED_BAMBOO_BLOCK")) return 8.00;
		if (n.equals("BAMBOO")) return 0.80;
		if (n.equals("DRIED_KELP_BLOCK")) return 8.00;
		if (n.equals("KELP")) return 0.60;
		if (n.equals("DRIED_KELP")) return 0.90;
		if (n.equals("SUGAR_CANE")) return 1.25;
		if (n.equals("CACTUS")) return 1.50;
		if (n.equals("NETHER_WART")) return 4.00;
		if (n.equals("WHEAT") || n.equals("CARROT") || n.equals("POTATO") || n.equals("BEETROOT")) return 1.25;
		if (n.endsWith("_SEEDS") || n.equals("PITCHER_POD") || n.equals("TORCHFLOWER_SEEDS")) return 0.40;
		if (n.equals("APPLE")) return 3.00;
		if (n.equals("BREAD")) return 4.00;
		if (n.equals("HAY_BLOCK")) return 11.00;
		if (n.equals("MELON") || n.equals("PUMPKIN") || n.equals("CARVED_PUMPKIN") || n.equals("JACK_O_LANTERN")) {
			return 4.00;
		}
		if (n.equals("MELON_SLICE")) return 0.75;
		if (n.startsWith("COOKED_")) return 5.00;
		...
		if (mat.isEdible()) return 3.00;

		// === Wood / logs ===
		if (n.endsWith("_LOG") || n.endsWith("_STEM") || n.endsWith("_HYPHAE") || n.endsWith("_WOOD")) return 5.00;
		if (n.contains("STRIPPED_") && (n.contains("LOG") || n.contains("STEM") || n.contains("WOOD") || n.contains("HYPHAE"))) {
			return 5.50;
		}
		if (n.endsWith("_PLANKS")) return 1.50;
		if (n.endsWith("_SAPLING") || n.endsWith("_PROPAGULE")) return 2.00;
		if (n.endsWith("_LEAVES") || n.equals("LEAF_LITTER")) return 0.40;
		...
		// === Stone / dirt ===
		if (n.equals("COBBLESTONE") || n.equals("COBBLED_DEEPSLATE")) return 1.00;
		...
		if (n.equals("NETHERRACK") || n.equals("BASALT") || n.equals("BLACKSTONE")) return 0.80;
		if (n.equals("END_STONE")) return 3.00;
		if (n.equals("SAND") || n.equals("RED_SAND")) return 2.00;
		if (n.equals("DIRT") || n.equals("COARSE_DIRT") || n.equals("ROOTED_DIRT") || n.equals("MUD")
				|| n.equals("GRAVEL") || n.equals("CLAY") || n.equals("SOUL_SAND") || n.equals("SOUL_SOIL")) {
			if (n.equals("CLAY")) return 3.00;
			if (n.equals("SOUL_SAND") || n.equals("SOUL_SOIL")) return 2.50;
			return 1.00;
		}
		if (n.equals("OBSIDIAN")) return 40.00;
		if (n.equals("CRYING_OBSIDIAN")) return 55.00;
		if (n.equals("GLOWSTONE")) return 20.00;
		if (n.equals("GLOWSTONE_DUST")) return 5.00;
		if (n.contains("TERRACOTTA") || n.contains("CONCRETE") || n.endsWith("_WOOL") || n.endsWith("_CARPET")
				|| n.contains("GLAZED_TERRACOTTA")) {
			return 4.00;
		}
		if (n.contains("GLASS") || n.contains("STAINED_GLASS")) return 2.50;
		if (n.endsWith("_BED")) return 20.00;
		if (n.endsWith("_BANNER") || n.equals("SHIELD")) return 15.00;

		// === Rails / machines ===
		if (n.contains("RAIL") || n.equals("MINECART") || n.contains("_MINECART")) return 20.00;
		if (n.equals("ENCHANTING_TABLE") || n.equals("ENDER_CHEST") || n.equals("ANVIL")
				|| n.equals("CHIPPED_ANVIL") || n.equals("DAMAGED_ANVIL")) {
			return 400.00;
		}
		if (n.equals("HOPPER") || n.equals("BREWING_STAND")) return 80.00;
		...
		// === Potions ===
		if (n.equals("GLASS_BOTTLE")) return 1.50;
		if (n.contains("POTION") || n.equals("HONEY_BOTTLE")) return 20.00;

		// === Coral / flowers / plants ===
		if (n.contains("CORAL")) return 8.00;
		if (n.endsWith("_FLOWER") || n.equals("DANDELION") || n.equals("POPPY") || n.equals("BLUE_ORCHID")
			...
			return n.equals("WITHER_ROSE") ? 50.00 : 2.00;
		}
		...
		if (n.contains("ICE") || n.contains("SNOW") || n.equals("POWDER_SNOW_BUCKET")) return 2.00;
		...
		if (n.endsWith("_DYE")) return 3.00;
		if (n.equals("PAPER") || n.equals("MAP") || n.equals("FILLED_MAP")) return 1.50;
		...
		if (n.contains("SWORD") || n.contains("AXE") || n.contains("PICKAXE") || n.contains("HOE") || n.contains("SHOVEL")
			...
			if (n.startsWith("WOODEN_") || n.startsWith("LEATHER_")) return 8.00;
			if (n.startsWith("STONE_") || n.startsWith("CHAINMAIL_")) return 15.00;
			if (n.contains("NAUTILUS_ARMOR")) return 800.00;
			return 25.00;
		}

		try {
			if (Tag.LOGS.isTagged(mat)) return 5.00;
			if (Tag.PLANKS.isTagged(mat)) return 1.50;
			if (Tag.WOOL.isTagged(mat)) return 4.00;
			if (Tag.ITEMS_TRIMMABLE_ARMOR.isTagged(mat)) return 25.00;
